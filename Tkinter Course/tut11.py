...
def getvals():
    ...
    print(f"{phoneval.get(), genderval.get(),emergencyval.get(),paymentmodeval.get(),foodserviceval.get()}")
    with open("records.txt","a") as f:
        f.write(f"{phoneval.get(), genderval.get(),emergencyval.get(),paymentmodeval.get(),foodserviceval.get()}\n")
